...
if (isset($_SESSION['user_id'])) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (isset($_POST["generar_constancia"])) {
            ...
            $query_select_certificado = "SELECT * FROM huella_hidrica WHERE id = '$user_id'";
            ...
            if (mysqli_num_rows($resultado_certificado) > 0) {
                ...
                if ($fila = mysqli_fetch_assoc($resultado)) {
                    ...
                    $query_update = "INSERT INTO huella_hidrica (id, folio, fecha_finalizacion, avance, pdf_path) VALUES ('$user_id', '$folio', '$fecha_finalizacion', '$avance', '$pdf_file_name')";
