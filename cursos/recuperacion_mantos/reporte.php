...
if (isset($_SESSION['user_id'])) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (isset($_POST["generar_constancia"])) {
            ...
            $query_select_certificado = "SELECT * FROM mantos_acuiferos WHERE id = '$user_id'";
            ...
            if (mysqli_num_rows($resultado_certificado) > 0) {
                ...
                if ($fila = mysqli_fetch_assoc($resultado)) {
                    ...
                    $datosQR .= "Curso: Recuperacion de los Mantos Acuaiferos\n";
                    $datosQR .= "Folio: $folio\n";
                    ...
                    $query_update = "INSERT INTO mantos_acuiferos (id, folio, fecha_finalizacion, avance, pdf_path) VALUES ('$user_id', '$folio', '$fecha_finalizacion', '$avance', '$pdf_file_name')";
